...
$sql = "exec fourItemsSummary \"$GET_[grp]\"";
...
<div id="div3" class="auto-style1">
	...
	<?php echo "<font id=\"values\">$row[Available]</font>"; ?>
</div>
<div id="div4" class="auto-style1">
	<font id="headers">Oldest Waiting Queue</font><br />
	<?php
		$split = $row['split'];
	?>
	<?php echo "<font id=\"values_alt\">$split</font>"; ?>
</div>
<?php 
